...
if __name__ == '__main__':
    ...
    for i in range(126):
        if i < 10:
            f = open(DIRECTORY+"temp/parse_answer_new.ec2-user.20150604.195854.915961/output/part-0000"+str(i))
        elif i < 100:
            f = open(DIRECTORY+"temp/parse_answer_new.ec2-user.20150604.195854.915961/output/part-000"+str(i))
        else:
