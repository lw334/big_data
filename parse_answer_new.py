...
class MRParseAnswers(MRJob):
  ...
  def reducer(self, obs, results):
    ...
    if is_user:
      ...
      question_list = [None]*2
      question_list[QUES_NUM_ANSWER-3] = dic[QUES_NUM_ANSWER]
      question_list[QUES_FIRST_ANS-3] = dic[QUES_FIRST_ANS][0]
      yield obs, (QUESTION_LIST, question_list)
